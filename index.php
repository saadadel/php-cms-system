    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php
                $posts_per_page = 5;
                $posts_num_Q = "select count(post_id) from posts";
                ...
                $query = "select * from posts where post_status='published' limit {$starting_post}, {$posts_per_page}";
                ...
                ?>
                    <h2>
                        <a href="post.php?post_id=<?php echo $row['post_id'] ?>"><?php echo $post_title ?></a>
                    </h2>
                    <p class="lead">
                        by <a href="user_posts.php?username=<?php echo $post_author ?>"><?php echo $post_author ?></a>
                    </p>
                ...
                <ul class="pager">
                    <?php
                        if($current_page > 1)
                        {
                            ...
                            echo "<li class='previous'>
                                    <a href='index?page_num={$prev_page}'>&larr; Previous</a>
                                </li>";
                        }
                    ?>
                    ...
                    <?php
                        if($current_page < $pages_num)
                        {
                            ...
                            echo "<li class='next'>
                                    <a href='index?page_num={$next_page}'>Next &rarr;</a>
                                </li>";
                        }
                    ?>
                </ul>
